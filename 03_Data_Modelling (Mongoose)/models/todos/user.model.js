...
//whatever name is given in the moongose inside "" (for example User here) gets converted into lowercase and plural
// form in the actual database (here in DB, it will become "users"), if not already. If already lowercase and plural
// then no change and so on. Since MongoDB is a smart database
